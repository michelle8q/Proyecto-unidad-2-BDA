 ...
 * @author cinca
 */
public class FrmRegistroParametros extends javax.swing.JFrame {

    /**
     * Creates new form registroAnalisis
     */
    public FrmRegistroParametros() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistroParametros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRegistroParametros().setVisible(true);
            }
        });
    }
